...
import ChooseAmount from '../../../../../ui/components/dialogs/chooseAmount/ChooseAmount';
...
export default memo(ItemView, (prevProps, nextProps) => {
    // Return true if nothing important changed (prevent re-render)
